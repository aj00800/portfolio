...
export default function ContactInfo() {
  ...
  return (
    <motion.div
      style={{ y }}
      ref={container}
      className="relative flex min-h-screen flex-col items-center justify-between bg-black p-6 pt-32 text-white sm:justify-center"
    >
      <div className="w-full bg-black pt-[150px] sm:max-w-[1800px]">
        <div className="relative border-b border-gray-600 pb-12 sm:mx-[100px]">
          ...
          >
            <RoundedButton
              ...
              className=" absolute h-[100px] w-[100px] cursor-pointer items-center justify-center rounded-full bg-primary p-0 text-background sm:h-[200px] sm:w-[200px]"
            >
        ...
        <div className="mt-6 flex gap-5 sm:mx-[100px]">
          <RoundedButton>aj08abdullah@gmail.com</RoundedButton>
        </div>
        ...
        <div className="mt-20 flex flex-col justify-between p-5 2xs:mt-52 sm:mx-[100px] sm:mt-48 sm:flex-row">
          ...
          <div className="flex items-end gap-2">
            ...
            <Magnetic>
              <Link
                href="https://www.linkedin.com/in/abdullah-jamil-b47015284/"
                className={animatedUnderlineStyle}
              >
                Linkedin
              </Link>
