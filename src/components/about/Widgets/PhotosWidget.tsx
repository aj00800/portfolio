...
export default function PhotosWidget() {
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-gray-200 bg-white text-black shadow-sm transition-all duration-300 hover:shadow-md">
      {/* Photos icon badge */}
      ...
      {/* Digital nomad label */}
      <div className="p-5">
        <p className="text-sm font-medium text-black">Digital Nomad</p>
