...
export const repos: Repo[] = [
  {
    ...
    url: 'https://github.com/abdullah-jamil/telegram-bot-template',
    language: 'TypeScript',
  ...
  },
  {
    ...
    url: 'https://github.com/abdullah-jamil/portfolio',
    language: 'TypeScript',
  ...
  },
  {
    ...
    url: 'https://github.com/abdullah-jamil/voting-contract',
    language: 'Rust',
...
export default function OpenSourceShowcase() {
  ...
  return (
    <div
      ref={containerRef}
      className="relative overflow-hidden rounded-2xl border border-gray-200 bg-white p-4 text-black shadow-sm transition-all duration-300 hover:shadow-md"
    >
      <div className="mb-4 flex items-center justify-between">
        <div>
          ...
          <p className="text-xs text-gray-600">Templates & repos</p>
        </div>
        <Link
          href="https://github.com/"
          target="_blank"
          rel="noopener noreferrer"
          className="group flex items-center gap-1.5 rounded-full border border-gray-300 px-2.5 py-1 text-[11px] text-gray-700 transition-all hover:border-gray-400 hover:text-black"
        >
            ...
            <div className="flex items-center justify-between gap-2">
              <div className="flex flex-wrap gap-1">
                {repo.tags.map((tag) => (
                  <span
                    key={tag}
                    className="rounded-full border border-gray-300 bg-gray-100 px-2 py-0.5 text-[10px] font-medium text-gray-700 transition-colors hover:bg-gray-200 hover:text-black"
                  >
                    {tag}
                  </span>
                ))}
