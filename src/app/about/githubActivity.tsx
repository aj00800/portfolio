...
export default function GitHubContributionsGraph({
  ...
  return (
    <div
      ref={containerRef}
      className="rounded-2xl border border-gray-200 bg-white p-6 text-black shadow-sm transition-all duration-300 hover:shadow-md md:p-8"
    >
      ...
      <div className="flex">
        <div className="hidden pr-2 md:block">
          {days.map((day, i) => (
            <div
              key={day}
              className="mb-[2px] h-[13px] text-xs leading-3 text-gray-500"
            >
              {i % 2 === 0 ? day : ''}
            </div>
          ))}
